	...
	var isMobile = function isMobile() {
		var mobile = /ipad|android|blackberry|iphone/i.test(navigator.userAgent.toLowerCase());		
		if(mobile !== true) {
			return false;
		} else {
			return true;	
	...
	$(document).ready(function(){	
		//Obtain default width and heigth values of the logo to make the proper resize
		/*var heightLogoVpp = $("div#logo-wrapper").find("img").height();		
		var widthLogoVpp = $("div#logo-wrapper").find("img").width();*/
		...
		Pace.on('hide', function () {		
			...
			//FONT RESIZE ON black-title
			if ((isMobile === true) || $(window).width()<= 1199) {
				$(".black-title").each(function() {
					$(this).css('font-size','18px');
				});
				$("#logo-wrapper").find("img").height('60');
				$("#logo-wrapper").find("img").width('57');
			}
			...
			$(window).resize(function() {	
				...
				if ($(window).width()<= 600) {					
					...
					/*$("div#logo-wrapper").find("img").height('57');
					$("div#logo-wrapper").find("img").width('54');*/
				} else {
					$(".black-title").each(function() {
						 $(this).css('font-size','30px');						
					});
					
					/*$("div#logo-wrapper").find("img").height(heightLogoVpp);
					$("div#logo-wrapper").find("img").width(widthLogoVpp);					*/
				}
		...
		$(window).resize(function() {	
			if($(window).width()<=1199){
				...
				$("#logo-wrapper").find("img").height('76');					
				$("#logo-wrapper").find("img").width('70');
